...
export default function ProfessionalSignupScreen() {
  ...
  const fetchCategories = async () => {
    try {
      const response = await fetch('https://dalmas.pythonanywhere.com/api/categories/');
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      for (let i = 0; i < payloadOptions.length; i++) {
        ...
        try {
          registerResponse = await fetch('https://dalmas.pythonanywhere.com/api/register/', {
            method: 'POST',
            headers: {
      ...
      while (loginAttempts < 3 && !token) {
        ...
        try {
          const loginResponse = await fetch('https://dalmas.pythonanywhere.com/api/login/', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
      ...
      try {
        ...
        const userResponse = await fetch('https://dalmas.pythonanywhere.com/api/user/', {
          method: 'GET',
          headers: {
        ...
        if (userResponse.ok) {
          ...
          for (const endpoint of updateEndpoints) {
            try {
              const updateResponse = await fetch(`https://dalmas.pythonanywhere.com${endpoint}`, {
                method: 'PATCH',
                headers: {
                  'Authorization': `Bearer ${token}`,
                  'Content-Type': 'application/json',
